...
extends Mp4TagTextNumberField {
    ...
    public Mp4DiscNoField(int n2) {
        ArrayList arrayList;
        super(Mp4FieldKey.DISCNUMBER.getFieldName(), String.valueOf((int)n2));
    ...
    public Mp4DiscNoField(int n2, int n3) {
        ArrayList arrayList;
        super(Mp4FieldKey.DISCNUMBER.getFieldName(), String.valueOf((int)n2));
        this.numbers = arrayList = new ArrayList();
        arrayList.add((Object)new Short("0"));
    ...
    public Mp4DiscNoField(String string2) throws FieldDataInvalidException {
        ArrayList arrayList;
        super(Mp4FieldKey.DISCNUMBER.getFieldName(), string2);
        this.numbers = arrayList = new ArrayList();
        arrayList.add((Object)new Short("0"));
    ...
    public Mp4DiscNoField(String string2, ByteBuffer byteBuffer) throws UnsupportedEncodingException {
    ...
    public void setDiscNo(int n2) {
        this.numbers.set(1, (Object)((short)n2));
    }

    public void setDiscTotal(int n2) {
