...
implements ID3v24FrameBody {
    ...
    static {
        ENGINEER = StandardIPLSKey.ENGINEER.getKey();
        MIXER = StandardIPLSKey.MIXER.getKey();
    ...
    public FrameBodyTIPL(byte by, String string2) {
        super(by, string2);
    }

    public FrameBodyTIPL(byte by, List<Pair> list) {
    ...
    public FrameBodyTIPL(ByteBuffer byteBuffer, int n2) throws InvalidTagException {
        super(byteBuffer, n2);
    }
