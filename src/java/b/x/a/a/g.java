...
implements Interpolator {
    ...
    public g(Resources resources, Resources.Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        TypedArray typedArray = b.i.h.d.g.s(resources, theme, attributeSet, a.l);
    ...
    private void d(TypedArray typedArray, XmlPullParser xmlPullParser) {
        if (b.i.h.d.g.r(xmlPullParser, "pathData")) {
            String string = b.i.h.d.g.m(typedArray, xmlPullParser, "pathData", 4);
            Path path = c.e(string);
            if (path != null) {
                this.b(path);
                return;
            }
        ...
        if (b.i.h.d.g.r(xmlPullParser, "controlX1")) {
            if (b.i.h.d.g.r(xmlPullParser, "controlY1")) {
                float f2 = b.i.h.d.g.j(typedArray, xmlPullParser, "controlX1", 0, 0.0f);
                float f3 = b.i.h.d.g.j(typedArray, xmlPullParser, "controlY1", 1, 0.0f);
                boolean bl = b.i.h.d.g.r(xmlPullParser, "controlX2");
                if (bl == b.i.h.d.g.r(xmlPullParser, "controlY2")) {
                    if (!bl) {
                        this.c(f2, f3);
                        return;
                    }
                    this.a(f2, f3, b.i.h.d.g.j(typedArray, xmlPullParser, "controlX2", 2, 0.0f), b.i.h.d.g.j(typedArray, xmlPullParser, "controlY2", 3, 0.0f));
                    return;
                }
