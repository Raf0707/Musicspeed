...
public class e {
    private static Animator a(Context context, Resources resources, Resources.Theme theme, XmlPullParser xmlPullParser, float f2) throws XmlPullParserException, IOException {
        return e.b(context, resources, theme, xmlPullParser, Xml.asAttributeSet((XmlPullParser)xmlPullParser), null, 0, f2);
    }
     ...
     */
    private static Animator b(Context var0, Resources var1_1, Resources.Theme var2_2, XmlPullParser var3_3, AttributeSet var4_4, AnimatorSet var5_5, int var6_6, float var7_7) throws XmlPullParserException, IOException {
        ...
        do {
            block10 : {
                ...
                var9_9 = e.n(var0, var1_1, var2_2, var4_4, var7_7, var3_3);
                ** GOTO lbl16
            }
            if (var17_13.equals((Object)"animator")) {
                var9_9 = e.l(var0, var1_1, var2_2, var4_4, null, var7_7, var3_3);
lbl16: // 2 sources:
                var21_16 = false;
            } else if (var17_13.equals((Object)"set")) {
                var18_14 = new AnimatorSet();
                var19_15 = g.s(var1_1, var2_2, var4_4, b.x.a.a.a.h);
                e.b(var0, var1_1, var2_2, var3_3, var4_4, var18_14, g.k(var19_15, var3_3, "ordering", 0, 0), var7_7);
                var19_15.recycle();
                var9_9 = var18_14;
                var21_16 = false;
            } else {
                ...
                var26_17 = e.p(var0, var1_1, var2_2, var3_3, Xml.asAttributeSet((XmlPullParser)var3_3));
                if (var26_17 != null && var9_9 instanceof ValueAnimator) {
    ...
    private static PropertyValuesHolder e(TypedArray typedArray, int n2, int n3, int n4, String string) {
        ...
        if (bl3) {
            ...
            int n7 = n5 == 5 ? (int)typedArray.getDimension(n3, 0.0f) : (e.h(n5) ? typedArray.getColor(n3, 0) : typedArray.getInt(n3, 0));
            if (bl2) {
                int n8 = n6 == 5 ? (int)typedArray.getDimension(n4, 0.0f) : (e.h(n6) ? typedArray.getColor(n4, 0) : typedArray.getInt(n4, 0));
            ...
            propertyValuesHolder = null;
            if (bl2) {
                int n9 = n6 == 5 ? (int)typedArray.getDimension(n4, 0.0f) : (e.h(n6) ? typedArray.getColor(n4, 0) : typedArray.getInt(n4, 0));
    ...
    private static int g(Resources resources, Resources.Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        TypedArray typedArray = g.s(resources, theme, attributeSet, b.x.a.a.a.j);
        TypedValue typedValue = g.t(typedArray, xmlPullParser, "value", 0);
        boolean bl = typedValue != null;
        int n2 = 0;
        if (bl) {
            boolean bl2 = e.h(typedValue.type);
            n2 = 0;
            if (bl2) {
                n2 = 3;
            }
    ...
    public static Animator i(Context context, int n2) throws Resources.NotFoundException {
        if (Build.VERSION.SDK_INT >= 24) {
            return AnimatorInflater.loadAnimator((Context)context, (int)n2);
        }
        return e.j(context, context.getResources(), context.getTheme(), n2);
    }

    public static Animator j(Context context, Resources resources, Resources.Theme theme, int n2) throws Resources.NotFoundException {
        return e.k(context, resources, theme, n2, 1.0f);
    }

    /*
     * Exception decompiling
     */
    public static Animator k(Context var0, Resources var1_1, Resources.Theme var2_2, int var3_3, float var4_4) throws Resources.NotFoundException {
    ...
    private static ValueAnimator l(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ValueAnimator valueAnimator, float f2, XmlPullParser xmlPullParser) throws Resources.NotFoundException {
        TypedArray typedArray = g.s(resources, theme, attributeSet, b.x.a.a.a.g);
        TypedArray typedArray2 = g.s(resources, theme, attributeSet, b.x.a.a.a.k);
        if (valueAnimator == null) {
            valueAnimator = new ValueAnimator();
        }
        e.q(valueAnimator, typedArray, typedArray2, f2, xmlPullParser);
        int n2 = g.l(typedArray, xmlPullParser, "interpolator", 0, 0);
        if (n2 > 0) {
            valueAnimator.setInterpolator((TimeInterpolator)d.b(context, n2));
        }
        typedArray.recycle();
        if (typedArray2 != null) {
            typedArray2.recycle();
    ...
    private static Keyframe m(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int n2, XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        TypedArray typedArray = g.s(resources, theme, attributeSet, b.x.a.a.a.j);
        float f2 = g.j(typedArray, xmlPullParser, "fraction", 3, -1.0f);
        TypedValue typedValue = g.t(typedArray, xmlPullParser, "value", 0);
        boolean bl = typedValue != null;
        if (n2 == 4) {
            n2 = bl && e.h(typedValue.type) ? 3 : 0;
        }
        Object object = bl ? (n2 != 0 ? (n2 != 1 && n2 != 3 ? null : Keyframe.ofInt((float)f2, (int)g.k(typedArray, xmlPullParser, "value", 0, 0))) : Keyframe.ofFloat((float)f2, (float)g.j(typedArray, xmlPullParser, "value", 0, 0.0f))) : (n2 == 0 ? Keyframe.ofFloat((float)f2) : Keyframe.ofInt((float)f2));
        int n3 = g.l(typedArray, xmlPullParser, "interpolator", 1, 0);
        if (n3 > 0) {
            object.setInterpolator((TimeInterpolator)d.b(context, n3));
        }
        typedArray.recycle();
        return object;
    }
    ...
    private static ObjectAnimator n(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, float f2, XmlPullParser xmlPullParser) throws Resources.NotFoundException {
        ...
        e.l(context, resources, theme, attributeSet, (ValueAnimator)objectAnimator, f2, xmlPullParser);
        return objectAnimator;
    }

    private static PropertyValuesHolder o(Context context, Resources resources, Resources.Theme theme, XmlPullParser xmlPullParser, String string, int n2) throws XmlPullParserException, IOException {
        int n3;
        ...
        while ((n3 = xmlPullParser.next()) != 3 && n3 != 1) {
            ...
            if (n2 == 4) {
                n2 = e.g(resources, theme, Xml.asAttributeSet((XmlPullParser)xmlPullParser), xmlPullParser);
            }
            if ((keyframe = e.m(context, resources, theme, Xml.asAttributeSet((XmlPullParser)xmlPullParser), n2, xmlPullParser)) != null) {
                if (arrayList == null) {
            ...
            if (n4 > 0) {
                ...
                if (f3 < 1.0f) {
                    if (f3 < 0.0f) {
                        ...
                        arrayList.add(arrayList.size(), (Object)e.c(keyframe2, 1.0f));
                        ++n4;
                    }
                }
                if ((f2 = keyframe.getFraction()) != 0.0f) {
                    if (f2 < 0.0f) {
                        ...
                        arrayList.add(0, (Object)e.c(keyframe, 0.0f));
                        ++n4;
                    }
                }
                    ...
                    if (object.getFraction() < 0.0f) {
                        if (n5 == 0) {
                            ...
                            if (n5 == n6) {
                                ...
                                e.d((Keyframe[])arrobject, arrobject[n8 + 1].getFraction() - arrobject[n5 - 1].getFraction(), n5, n8);
                            }
                        }
                    }
                    ++n5;
    ...
    private static PropertyValuesHolder[] p(Context context, Resources resources, Resources.Theme theme, XmlPullParser xmlPullParser, AttributeSet attributeSet) throws XmlPullParserException, IOException {
        ...
        do {
            ...
            if (xmlPullParser.getName().equals((Object)"propertyValuesHolder")) {
                int n3;
                TypedArray typedArray = g.s(resources, theme, attributeSet, b.x.a.a.a.i);
                String string = g.m(typedArray, xmlPullParser, "propertyName", 3);
                PropertyValuesHolder propertyValuesHolder = e.o(context, resources, theme, xmlPullParser, string, n3 = g.k(typedArray, xmlPullParser, "valueType", 2, 4));
                if (propertyValuesHolder == null) {
                    propertyValuesHolder = e.e(typedArray, n3, 0, 1, string);
                }
                if (propertyValuesHolder != null) {
                    if (arrayList == null) {
                        arrayList = new ArrayList();
    ...
    private static void q(ValueAnimator valueAnimator, TypedArray typedArray, TypedArray typedArray2, float f2, XmlPullParser xmlPullParser) {
        long l2 = g.k(typedArray, xmlPullParser, "duration", 1, 300);
        long l3 = g.k(typedArray, xmlPullParser, "startOffset", 2, 0);
        int n2 = g.k(typedArray, xmlPullParser, "valueType", 7, 4);
        if (g.r(xmlPullParser, "valueFrom") && g.r(xmlPullParser, "valueTo")) {
            PropertyValuesHolder propertyValuesHolder;
            if (n2 == 4) {
                n2 = e.f(typedArray, 5, 6);
            }
            if ((propertyValuesHolder = e.e(typedArray, n2, 5, 6, "")) != null) {
        ...
        valueAnimator.setRepeatCount(g.k(typedArray, xmlPullParser, "repeatCount", 3, 0));
        valueAnimator.setRepeatMode(g.k(typedArray, xmlPullParser, "repeatMode", 4, 1));
        if (typedArray2 != null) {
            e.r(valueAnimator, typedArray2, n2, f2, xmlPullParser);
        }
    }
    ...
    private static void r(ValueAnimator valueAnimator, TypedArray typedArray, int n2, float f2, XmlPullParser xmlPullParser) {
        ...
        String string = g.m(typedArray, xmlPullParser, "pathData", 1);
        if (string != null) {
            String string2 = g.m(typedArray, xmlPullParser, "propertyXName", 2);
            String string3 = g.m(typedArray, xmlPullParser, "propertyYName", 3);
            if (n2 != 2) {
                // empty if block
            }
            ...
            e.s(c.e(string), objectAnimator, f2 * 0.5f, string2, string3);
            return;
        }
        objectAnimator.setPropertyName(g.m(typedArray, xmlPullParser, "propertyName", 0));
    }
    ...
    private static void s(Path path, ObjectAnimator objectAnimator, float f2, String string, String string2) {
        ...
        for (int i2 = 0; i2 < n2; ++i2) {
            pathMeasure2.getPosTan(f3 - ((Float)arrayList.get(n3)).floatValue(), arrf3, null);
            arrf[i2] = arrf3[0];
            arrf2[i2] = arrf3[1];
            f3 += f5;
            int n4 = n3 + 1;
    ...
    implements TypeEvaluator<c.b[]> {
        ...
        public c.b[] a(float f2, c.b[] arrb, c.b[] arrb2) {
            if (c.b(arrb, arrb2)) {
                if (!c.b(this.a, arrb)) {
                    this.a = c.f(arrb);
                }
