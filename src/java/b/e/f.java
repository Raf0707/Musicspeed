...
abstract class f<K, V> {
    ...
    implements Iterator<T> {
        ...
        public T next() {
            if (this.hasNext()) {
                Object object = f.this.b(this.h, this.f);
                this.h = 1 + this.h;
                this.i = true;
                return (T)object;
            }
    ...
    implements Set<Map.Entry<K, V>> {
        ...
        public boolean contains(Object object) {
            ...
            int n2 = f.this.e(entry.getKey());
            if (n2 < 0) {
                return false;
            }
            return b.e.c.c(f.this.b(n2, 1), entry.getValue());
        }
        ...
        public int hashCode() {
            int n2 = 0;
            for (int i2 = f.this.d() - 1; i2 >= 0; --i2) {
                Object object = f.this.b(i2, 0);
                Object object2 = f.this.b(i2, 1);
    ...
    Map.Entry<K, V> {
        ...
        public boolean equals(Object object) {
            if (this.h) {
                ...
                Map.Entry entry = (Map.Entry)object;
                boolean bl = b.e.c.c(entry.getKey(), f.this.b(this.g, 0));
                boolean bl2 = false;
                if (bl) {
                    boolean bl3 = b.e.c.c(entry.getValue(), f.this.b(this.g, 1));
                    bl2 = false;
                    if (bl3) {
                        bl2 = true;
                    }
        ...
        public int hashCode() {
            if (this.h) {
                Object object = f.this.b(this.g, 0);
                Object object2 = f.this.b(this.g, 1);
    ...
    implements Collection<V> {
        ...
        public boolean removeAll(Collection<?> collection) {
            ...
            for (int i2 = 0; i2 < n2; ++i2) {
                if (!collection.contains(f.this.b(i2, 1))) continue;
                f.this.h(i2);
                --i2;
                --n2;
                bl = true;
