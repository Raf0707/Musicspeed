...
extends j {
     ...
     */
    @Override
    public Typeface b(Context var1, c.b var2, Resources var3, int var4) {
    ...
    public Typeface e(Context context, Resources resources, int n2, String string, int n3) {
        try {
            Font font = new Font.Builder(resources, n2).build();
            Typeface typeface = new Typeface.CustomFallbackBuilder(new FontFamily.Builder(font).build()).setStyle(font.getStyle()).build();
            return typeface;
        }
