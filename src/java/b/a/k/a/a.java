...
public final class a {
    ...
    public static ColorStateList c(Context context, int n2) {
        ...
        ColorStateList colorStateList = a.b(context, n2);
        if (colorStateList != null) {
            return colorStateList;
        }
        ColorStateList colorStateList2 = a.f(context, n2);
        if (colorStateList2 != null) {
            a.a(context, n2, colorStateList2);
            return colorStateList2;
        }
        return b.i.h.a.d(context, n2);
    }

    public static Drawable d(Context context, int n2) {
        return f0.h().j(context, n2);
    }
    ...
    private static ColorStateList f(Context context, int n2) {
        ...
        try {
            ColorStateList colorStateList = b.i.h.d.a.a(resources, (XmlPullParser)xmlResourceParser, context.getTheme());
            return colorStateList;
        }
